...
addSubmission(submissions, "Nicole", 100, "2020 - 10 - 23");
...
// the splice method.
const deleteSubmissinByIndex = (array, index) => {
  array.splice(index, 1);
};
deleteSubmissinByIndex(submissions, 0);
console.log(submissions);
...
deleteSubmissionByName(submissions, "Nicole");
console.log(submissions);
...
const filterPassing = (array) => {
  let passingGrade = array.filter((item) => {
